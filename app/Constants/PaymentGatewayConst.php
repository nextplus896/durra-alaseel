...
class PaymentGatewayConst {
    ...
    public static function registerRedirection() {
        return [
            'web'       => [
                'return_url'    => 'user.car.booking.payment.success',
                'cancel_url'    => 'user.car.booking.payment.cancel',
                'callback_url'  => 'user.car.booking.payment.callback',
                'redirect_form' => 'user.car.booking.payment.redirect.form',
                'btn_pay'       => 'user.car.booking.payment.btn.pay',
            ],
            'api'       => [
                'return_url'    => 'api.user.car.booking.payment.success',
                'cancel_url'    => 'api.user.car.booking.payment.cancel',
                'callback_url'  => 'user.car.booking.payment.callback',
                'redirect_form' => 'user.car.booking.payment.redirect.form',
                'btn_pay'       => 'api.user.car.booking.payment.btn.pay',
            ],
        ];
    }
