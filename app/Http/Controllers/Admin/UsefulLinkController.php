...
class UsefulLinkController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $section_data['content']['language']  = $this->contentValidate($request,['content'   => 'required|string'],'link-add');
    ...
    public function edit($slug)
    {
        ...
        if(!$useful_link) return back()->with(['error' => [__('Link not found!')]]);
        $languages = Language::get();
    ...
    public function update(Request $request, $slug)
    {
        ...
        $section_data['content']['language']  = $this->contentValidate($request,['content'  => 'required|string']);
