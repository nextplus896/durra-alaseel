...
class PaymentGatewaysController extends Controller
{
    ...
    public function automaticAddMoneyView() {
        $page_title = __("Automatic Payment Methods");
    ...
    public function manualAddMoneyView() {
        $page_title = __("Manual Payment Methods");
    ...
    public function manualAddMoneyEdit($alias) {
        $page_title = __("Manual Payment Method Edit");
    ...
    public function manualAddMoneyCreate() {
        $page_title = __("Manual Payment Method");
