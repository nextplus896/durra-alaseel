...
class WebSettingsController extends Controller
{
    ...
    public function vendorBasicSettingsUpdate(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'vendor_base_color'        => 'required|string',
            'vendor_secondary_color'   => 'required|string',
        ]);
    ...
    public function vendorImageAssetsUpdate(Request $request)
    {
        $validator = Validator::make($request->all(), [
            'vendor_logo'         => 'nullable|image|mimes:png,jpeg,jpg,webp,svg',
            'vendor_logo_dark'    => 'nullable|image|mimes:png,jpeg,jpg,webp,svg',
            'vendor_fav'          => 'nullable|image|mimes:png,jpeg,jpg,webp,svg',
            'vendor_fav_dark'     => 'nullable|image|mimes:png,jpeg,jpg,webp,svg',
        ]);
        $validated = $validator->validate();
        ...
        return back()->with(['success' => [__('Company Image assets updated successfully!.')]]);
    }
