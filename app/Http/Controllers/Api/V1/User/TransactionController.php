    ...
    public function log(Request $request) {
        ...
        try{
            ...
            if(isset($validated['slug']) && $validated['slug'] != "") {
                $transactions = Transaction::vendorAuthApi()->where("type",$this->slugValue($validated['slug']))->orderByDesc("id")->get();
            }else {
                $transactions = Transaction::vendorAuthApi()->orderByDesc("id")->get();
            }
