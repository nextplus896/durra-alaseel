...
class SettingController extends Controller
{
    public function basicSettings() {
        ...
        $vendor_app_settings = AppSettings::select('vendor_splash_screen_image as image','vendor_version')->first();
        ...
        $vendor_onboard_screens = VendorAppOnboardScreen::select("title","sub_title","image","status")->where("status",GlobalConst::ACTIVE)->orderByDesc('id')->get();
        $vendor_onboard_screens->makeHidden(['editData']);
        ...
        return Response::success([__("Basic settings fetch successfully!")],[
            ...
            'base_cur'          => $base_cur,
            'web_links'         => [
                'privacy-policy'    => setRoute('global.useful.page',UsefulLink::where('type',GlobalConst::USEFUL_LINK_PRIVACY_POLICY)->first()?->slug),
            ...
            'vendor_splash_screen'     => $vendor_app_settings,
    ...
    public function getCountries() {
        return Response::success([__("countries data fetch successfully!")],[
