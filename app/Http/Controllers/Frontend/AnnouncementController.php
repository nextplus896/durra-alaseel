...
class AnnouncementController extends Controller
{
    ...
    public function categoryStore(Request $request)
    {
        ...
        $data['language']  = $this->contentValidate($request,$basic_field_name,'category-add');
    ...
    public function announcementCreate() {
        $page_title = __("Create New Announcement");
    ...
    public function announcementStore(Request $request) {
        ...
        if(Announcement::where('slug',$slug)->exists()) return back()->with(['error' => [__('Blog title is similar. Please update/change this title')]]);
        ...
        return redirect()->route('admin.setup.sections.announcement.index')->with(['success' => [__('Blog created successfully!')]]);
    }
    ...
    public function announcementEdit($id) {
        ...
        if(!$announcement) return back()->with(['error' => [__("Announcement does't exists!")]]);
    ...
    public function announcementUpdate(Request $request,$id) {
        ...
        return redirect()->route('admin.setup.sections.announcement.index')->with(['success' => [__('Blog updated successfully!')]]);
    }
