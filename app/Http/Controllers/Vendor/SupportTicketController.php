...
class SupportTicketController extends Controller
{
    ...
    public function index()
    {
        ...
        $support_tickets = UserSupportTicket::vendorAuthTickets()->orderByDesc("id")->paginate(10);
        return view('vendor-end.sections.support-ticket.index', compact('page_title','support_tickets'));
    }
    ...
    public function create()
    {
        ...
        return view('vendor-end.sections.support-ticket.create', compact('page_title'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('vendor.support.ticket.index'))->with(['success' => ['Support ticket created successfully!']]);
    ...
    public function conversation($encrypt_id)
    {
        ...
        $page_title = "";
        return view('vendor-end.sections.support-ticket.conversation', compact('page_title','support_ticket'));
    }
