...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'verification.guard.vendor'  => \App\Http\Middleware\Vendor\VerificationGuard::class,
        'user.google.two.factor'    => \App\Http\Middleware\User\GoogleTwoFactor::class,
        'vendor.google.two.factor'    => \App\Http\Middleware\Vendor\GoogleTwoFactor::class,
        ...
        'page.check'               => \App\Http\Middleware\Admin\Checkpage::class,
        ...
        'api.vendor.auth.guard'           => \App\Http\Middleware\Api\V1\Vendor\AuthGuard::class,
    ];
}
