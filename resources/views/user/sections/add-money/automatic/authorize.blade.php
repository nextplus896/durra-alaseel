            ...
            <div class="checkout-section">
                <div class="checkout-wrapper">
                    ...
                    <form id="payment-form"
                        action="{{ setRoute('user.car.booking.authorize.payment.submit', $temp_data->identifier) }}"
                        method="post" class="checkout-form" novalidate>
                        @csrf
                        ...
                        <div class="row mb-10-none">
                            <div class="col-lg-6 col-md-6 col-sm-6 mb-10">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="expiry" name="date" class="form-control"
                                        placeholder="YY / MM" required>
                                    <div class="invalid-feedback">
                                        {{ __('Please enter a valid future expiration date (YY/MM)') }}</div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 mb-10">
                                <div class="form-group">
                                    <label for="cvc" class="form-label">{{ __('Security Code') }}
                                        {{ __('CVV/CVC') }}*</label>
                                    <div class="cvc-container">
                                        <input type="text" id="cvc" name="code" class="form-control"
                                            placeholder="CVC" required>
                                    </div>
                                    <div class="invalid-feedback">
                                        {{ __('Please enter a valid 3 or 4 digit security code') }}
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="preview-list-wrapper">
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span
                                        class="request-amount">{{ get_amount(@$temp_data->data->amount->requested_amount, @$temp_data->data->amount->default_currency, 4) }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span class="request-amount">{{ __('1') }} {{ get_default_currency_code() }} =
                                        {{ get_amount(@$temp_data->data->amount->sender_cur_rate, @$temp_data->data->amount->sender_cur_code, 4) }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span
                                        class="fees">{{ get_amount(@$temp_data->data->amount->total_charge, @$temp_data->data->amount->sender_cur_code, 4) }}
                                    </span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                ...
                                <div class="preview-list-right">
                                    <span
                                        class="will-get">{{ get_amount(@$temp_data->data->amount->requested_amount, @$temp_data->data->amount->default_currency, 4) }}</span>
                                </div>
                            </div>
                            <div class="preview-list-item">
                                <div class="preview-list-left">
                                ...
                                <div class="preview-list-right">
                                    <span
                                        class="text--warning last pay-in-total">{{ get_amount(@$temp_data->data->amount->total_amount, @$temp_data->data->amount->sender_cur_code, 4) }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
