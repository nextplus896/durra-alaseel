...
<body>
                    ...
                    <div class="verification-otp-area">
                        <div class="account-wrapper otp-verification">
                            ...
                            <div class="verification-otp-content">
                                <h4 class="title text-center">{{ __('Need to verify your account') }}</h4>
                                <p class="d-block text-center">{{ __('We sent a 6 digit code here') }}</p>
                            </div>
                            <form class="account-form pt-20" action="{{ setRoute('user.car.booking.mail.verify', $token) }}" method="POST">
                                @csrf
    ...
    <script>
        var convertAsSecond = "{{ global_const()::USER_PASS_RESEND_TIME_MINUTE }}" * 10;
        ...
        function resetTime(second = convertAsSecond) {
            ...
            var x = setInterval(function() {
                ...
                var resendCodeLink = "{{ setRoute('user.car.booking.mail.resend', $token) }}";
