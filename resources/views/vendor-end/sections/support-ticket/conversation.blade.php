...
@section('breadcrumb')
    @include('user.components.breadcrumb', [
        'breadcrumbs' => [
            [
                'name' => __('Dashboard'),
                'url' => setRoute('vendor.dashboard.index'),
            ],
        ],
        ...
        <div class="support-card-wrapper">
            <div class="card-header">
                <div class="card-header-user-area">
                    <img class="avatar" src="{{ get_image($support_ticket->vendor->image, 'user-profile') }}" alt="client">
                    <div class="card-header-user-content">
                        <h6 class="title">{{ $support_ticket->vendor->fullname }}</h6>
...
@include('admin.components.support-ticket.conversation.connection-user', [
    ...
    'route' => setRoute('vendor.support.ticket.messaage.send'),
])
