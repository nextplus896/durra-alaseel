            ...
            <div class=" col-xl-6 col-lg-8 col-md-10 col-sm-12">
                <div class="verification-otp-area">
                    <div class="account-wrapper otp-verification">
                        ...
                        <form class="account-form pt-20" action="{{ setRoute('vendor.password.forgot.verify.code',$token) }}" method="POST">
                            @csrf
...
<script>
    ...
    var resendCodeLink = "{{ setRoute('vendor.password.forgot.resend.code', $token) }}";
    function resetTime (second = 0) {
        ...
        var x = setInterval(function () {  // Get today's date and time
            ...
            if (distance < 0 || second < 2 ) {
                ...
                document.querySelector(".time-area").innerHTML = "Didn't get the code? <a href='{{ setRoute('vendor.password.forgot.resend.code', $token) }}' class='text--danger'>Resend</a>";
            }
            second--
        }, 1000);
    }
