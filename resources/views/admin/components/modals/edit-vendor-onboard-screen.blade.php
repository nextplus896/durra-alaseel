@if (admin_permission_by_name("admin.app.settings.onboard.vendor.screen.update"))
    <div id="onboard-screen-edit" class="mfp-hide large">
        <div class="modal-data">
            ...
            <div class="modal-form-data">
                <form class="modal-form" method="POST" action="{{ setRoute('admin.app.settings.onboard.vendor.screen.update') }}" enctype="multipart/form-data">
                    @csrf
                    @method("PUT")
