<div class="custom-card mb-10">
    ...
    <div class="card-body">
        <form class="card-form" method="POST" action="{{ $route ?? "" }}">
            ...
            <div class="row">
                <div class="@if ($data->slug == 'cash') col-xl-6 col-lg-6 mb-10 @else col-xl-4 col-lg-4 mb-10 @endif">
                ...
                <div class="col-xl-4 col-lg-4 mb-10 @if ($data->slug == 'cash') d-none @endif">
                    <div class="custom-inner-card">
                        <div class="card-inner-header">
