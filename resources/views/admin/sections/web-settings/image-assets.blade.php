...
@section('content')
    ...
    <div class="custom-card">
        <div class="card-header">
            <h6 class="title">{{ __("Image Assets") }} ({{ __("Vendor") }})</h6>
        </div>
        <div class="card-body">
            <form class="card-form" method="POST" action="{{ setRoute('admin.web.settings.vendor.image.assets.update') }}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="row mb-10-none">
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group" style="height: 300px">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Vendor Logo (Light Version)"),
                            'class'             => "file-holder",
                            'name'              => "vendor_logo",
                            'old_files'         => $basic_settings->vendor_logo,
                            'old_files_path'    => files_asset_path('image-assets'),
                        ])
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group image-dark">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Vendor Logo (Dark Version)"),
                            'class'             => "file-holder",
                            'name'              => "vendor_logo_dark",
                            'old_files'         => $basic_settings->vendor_logo_dark,
                            'old_files_path'    => files_asset_path('image-assets'),
                        ])
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Vendor Favicon (Light Version)"),
                            'class'             => "file-holder",
                            'name'              => "vendor_fav",
                            'old_files'         => $basic_settings->vendor_fav,
                            'old_files_path'    => files_asset_path('image-assets'),
                        ])
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group image-dark">
                        @include('admin.components.form.input-file',[
                            'label'             => __("Vendor Favicon (Dark Version)"),
                            'class'             => "file-holder",
                            'name'              => "vendor_fav_dark",
                            'old_files'         => $basic_settings->vendor_fav_dark,
                            'old_files_path'    => files_asset_path('image-assets'),
                        ])
                    </div>
                    <div class="col-xl-12 col-lg-12 form-group">
                        @include('admin.components.button.form-btn',[
                            'class'         => "w-100 btn-loading",
                            'text'          => __("Update"),
                            'permission'    => "admin.web.settings.company.image.assets.update",
                        ])
                    </div>
                </div>
            </form>
