...
@section('breadcrumb')
    ...
    ], 'active' => __("Vendor Splash Screen")])
@endsection

@section('content')
    <div class="custom-card">
        <div class="card-header">
            <h6 class="title">{{ __("Vendor Splash Screen") }}</h6>
        </div>
        <div class="card-body">
            <form class="card-form" method="POST" action="{{ setRoute('admin.app.settings.vendor.splash.screen.update') }}" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                    ...
                    <div class="col-xl-10 col-lg-10 col-md-9 col-sm-8">
                        <div class="form-group">
                            @include('admin.components.form.input',[
                                ...
                                'value'         => old('version',$app_settings->vendor_version),
                            ])
                        </div>
                    </div>
