        ...
        <div class="support-card-wrapper">
            <div class="card-header">
                <div class="card-header-user-area">
                    <img class="avatar" src="{{ get_image( $support_ticket->user_id ? $support_ticket->user->image : $support_ticket->vendor->image ,"user-profile") }}" alt="client">
                    <div class="card-header-user-content">
                        <h6 class="title">{{ $support_ticket->user_id ? $support_ticket->user->fullname : $support_ticket->vendor->fullname }}</h6>
