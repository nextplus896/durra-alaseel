                ...
                <div class="row mb-10-none">
                        ...
                        <div class="d-flex align-items-center mt-2">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" role="switch" name="delivery_enabled"
                                    id="delivery_enabled" value="1" {{ old('delivery_enabled') ? 'checked' : '' }}>
                    ...
                    <div class="col-xl-6 col-lg-6 form-group">
                        ...
                        <input type="text" name="name" class="form--control"
                            placeholder="{{ __('Enter branch name') }}" value="{{ old('name') }}" required>
                    </div>
                    <div class="col-xl-6 col-lg-6 form-group">
                        ...
                        <input type="number" name="service_radius_km" class="form--control"
                            ...
                            value="{{ old('service_radius_km', 10) }}" step="0.1" min="0.1" max="500"
                            required>
                    </div>
                    <div class="col-xl-12 col-lg-12 form-group">
