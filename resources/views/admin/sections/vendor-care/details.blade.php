...
@section('content')
            ...
            <div class="row">
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Vendor Wallet") }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ get_amount($user->wallets->balance)}} {{ get_default_currency_code() }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Ride Complete") }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ $ride_complete }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Booking Rejected") }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ $booking_rejects }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-xxxl-4 col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12 mb-15">
                    <div class="dashbord-item">
                        <div class="dashboard-content">
                            <div class="left">
                                <h6 class="title">{{ __("Round Trips") }}</h6>
                                <div class="user-info">
                                    <h2 class="user-count">{{ $round_trips }}</h2>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="custom-card mt-15">
        <div class="card-header">
            <h6 class="title">{{ __("Vendor Overview") }}</h6>
        </div>
        <div class="card-body">
                        ...
                        <div class="user-action-btn-area">
                            ...
                            <div class="user-action-btn">
                                @include('admin.components.link.custom',[
                                    'href'          => setRoute('admin.vendor.login.logs',$user->username),
                                    'class'         => "bg--base two",
                                    'icon'          => "las la-sign-in-alt me-1",
                                    'text'          => __("Login Logs"),
                                    'permission'    => "admin.vendor.login.logs",
                                ])
                            </div>
                            <div class="user-action-btn">
                                @include('admin.components.link.custom',[
                                    ...
                                    'text'          =>  __("Send Email"),
                                    'permission'    => "admin.vendor.send.mail",
                                ])
                            </div>
                            <div class="user-action-btn">
                                @include('admin.components.link.custom',[
                                    ...
                                    'permission'    => "admin.vendor.login.as.member",
                                ])
                            </div>
                            <div class="user-action-btn">
                                @include('admin.components.link.custom',[
                                    'href'          => setRoute('admin.vendor.mail.logs',$user->username),
                                    'class'         => "bg--base five",
                                    'icon'          => "las la-history me-1",
                                    'text'          =>__("Email Logs"),
                                    'permission'    => "admin.vendor.mail.logs",
                                ])
                            </div>
                        </div>
                    </div>
    ...
    <div class="custom-card mt-15">
        <div class="card-header">
            <h6 class="title">{{ __("Information of Vendor") }}</h6>
        </div>
        <div class="card-body">
            <form class="card-form" method="POST" action="{{ setRoute('admin.vendor.details.update',$user->username) }}">
                @csrf
                <div class="row mb-10-none">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                        @include('admin.components.form.switcher', [
                            ...
                            'permission'    => "admin.vendor.details.update",
                        ])
                    </div>
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 form-group">
                        @include('admin.components.form.switcher', [
    ...
    {{-- Send Email Modal --}}
    @include('admin.components.modals.send-mail-vendor',compact("user"))

    {{-- User Balance Update Modal --}}
    @if (admin_permission_by_name('admin.vendor.wallet.balance.update'))
            ...
            <div class="modal-data">
                ...
                <div class="modal-form-data">
                    <form class="modal-form" method="POST"
                        action="{{ setRoute('admin.vendor.wallet.balance.update', $user->username) }}"
                        ...
                        <div class="row mb-10-none">
                            ...
                            <div class="col-xl-12 col-lg-12 form-group">
                                <label for="wallet">{{ __('Vendor Wallet') }}<span>*</span></label>
                                <select name="wallet" id="wallet" class="form--control select2-auto-tokenize">
                                    <option disabled selected value="">{{ __('Select Vendor Wallet') }}</option>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(".login-as-member").click(function() {
                var action  = "{{ setRoute('admin.vendor.login.as.member',$user->username) }}";
