...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#choose-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i> {{ __("Add Choosing Reason") }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                <td><span class="text--dark">{{ textLength($item->language->$system_default_lang->description ?? "",60) }}</span></td>
                                <td>
    ...
    {{-- Choose Us Item Edit Modal --}}
    <div id="choose-edit" class="mfp-hide large">
        <div class="modal-data">
            <div class="modal-header px-0">
                <h5 class="modal-title">{{ __("Edit Security") }}</h5>
            </div>
