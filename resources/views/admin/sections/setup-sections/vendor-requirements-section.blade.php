...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#vendor-requirements-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add vendor-requirements') }}</a>
                </div>
            </div>
                        ...
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td>
                                    ...
                                    <a href="{{ setRoute('admin.setup.sections.requirements.details', [$item->id]) }}"
    ...
    @include('admin.components.modals.site-section.vendor-requirements-section.add')
    @include('admin.components.modals.site-section.vendor-requirements-section.edit')
@endsection
...
@push('script')
    ...
    <script>
        openModalWhenError("vendor-requirements-add", "#vendor-requirements-add");
        openModalWhenError("vendor-requirements-edit", "#vendor-requirements-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#vendor-requirements-edit");
            ...
            fileHolderPreviewReInit("#vendor-requirements-edit input[name=image_edit]");
            openModalBySelector("#vendor-requirements-edit");
