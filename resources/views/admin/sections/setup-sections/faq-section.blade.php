...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#faq-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
                            ...
                            <tr data-item="{{ json_encode($item) }}">
                                <td>
                                    <span class="text--dark">
                                        {{ textLength($item->language->$system_default_lang->question ?? '' , 20) }}
                                    </span>
                                </td>
                                <td>
                                    <span class="text--dark">
                                        {{ textLength($item->language->$system_default_lang->answer ?? '' , 50) }}
                                    </span>
                                </td>
                                <td>
    ...
    @include('admin.components.modals.site-section.add-faq-page-item')

    {{-- edit modal --}}
    <div id="faq-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("faq-item-add", "#faq-item-add");
        openModalWhenError("faq-item-edit", "#faq-item-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            var editModal = $("#faq-item-edit");

            editModal.find("form").first().find("input[name=target]").val(oldData.id);

            $.each(languages, function(index, item) {
                editModal.find("input[name=" + item.code + "_question_edit]").val(oldData.language[item.code]
                    ?.question);
                editModal.find("input[name=" + item.code + "_answer_edit]").val(oldData.language[item.code]
                    ?.answer);
            });
            openModalBySelector("#faq-item-edit");
