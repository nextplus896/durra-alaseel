                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td><span class="text--dark">{{ textLength($item->language->$system_default_lang->title ?? "" ,15) }}</span></td>
                                <td><span class="text--dark">{{ textLength($item->language->$system_default_lang->description ?? "" ,30) }}</span></td>
                                <td>
