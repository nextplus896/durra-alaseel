...
@section('content')
        ...
        <div class="table-wrapper">
            <div class="table-header justify-content-end">
                <div class="table-btn-area">
                    <a href="#stat-item-add" class="btn--base modal-btn"><i class="fas fa-plus me-1"></i>
                        {{ __('Add Item') }}</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse ($data->value->items ?? [] as $key => $item)
                            <tr data-item="{{ json_encode($item) }}">
                                ...
                                <td><span
                                        class="text--dark">{{ $item->amount ?? '' }}</span>
                                </td>
                                <td>
    ...
    @include('admin.components.modals.site-section.add-stat-item')

    {{-- edit modal --}}
    <div id="stat-item-edit" class="mfp-hide large">
...
@push('script')
    ...
    <script>
        openModalWhenError("stat-item-add", "#stat-item-add");
        openModalWhenError("stat-item-edit", "#stat-item-edit");
        ...
        $(".edit-modal-button").click(function() {
            ...
            openModalBySelector("#stat-item-edit");
